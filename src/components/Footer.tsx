    ...
    <footer className="bg-[#1B5E20] text-white px-6 py-12">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <Link href="/services" className="text-green-100 text-sm hover:text-white transition">Services</Link>
              <Link href="/about" className="text-green-100 text-sm hover:text-white transition">About Us</Link>
              <Link href="/locations" className="text-green-100 text-sm hover:text-white transition">Locations</Link>
              <Link href="/contact" className="text-green-100 text-sm hover:text-white transition">Get a Free Machine</Link>
            </div>
          </div>
        ...
        <div className="border-t border-white/20 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-green-200 text-xs">Family-owned · Serving DFW since 2025</p>
        </div>
